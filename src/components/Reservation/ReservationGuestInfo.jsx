      ...
      <div className="flex flex-col gap-4 border-b p-4 mb-4">
        ...
        <div id="guestInfo" className="flex flex-col gap-4 ml-4 font-semibold">
          <div className="flex items-center gap-4">
            <label htmlFor="reservedName" className="w-1/6">예약명<span className="text-red-600 align-text-bottom">*</span></label>
          ...
          <div className="flex items-center gap-4">
            <label htmlFor="tel" className="w-1/6">연락처<span className="text-red-600 align-text-bottom">*</span></label>
          ...
          <div className="flex items-center gap-4">
            <label htmlFor="reservedName" className="w-1/6">이메일<span className="text-red-600 align-text-bottom">*</span></label>
